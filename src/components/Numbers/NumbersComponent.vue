        ...
        <div class="row">
            <div class="col-md-6" style="padding: 30px 145px 0;display: flex;flex-direction: column;">
                ...
                <div class="text-center" style="padding: 0 20px 0;font-size: 115px">
                    <p @mouseover="playAudio()" style="font-size: 115px;text-shadow: 0px 3px grey;cursor: url('/storage/Images/audio2.png') 25 25,auto;" :style="{color: chosenNumber.color}">{{chosenNumber.nameEN}}</p>
                </div>
            </div>
            ...
            <div class="col-sm-12 col-12">
                <div class="pagerArea text-center">
                    <ul class="pager">
                        <li class="space-bottom" v-on:click="changeNumber(indexOfChosen,'right')"><button type="button" class="btn btn-outline-info not-rounded"><i class="fa fa-arrow-left" aria-hidden="true"></i><span>Prev</span></button></li>
                        <li class="space-bottom" v-on:click="changeNumber(indexOfChosen,'left')"><button type="button" class="btn btn-outline-info not-rounded"><span>Next</span><i class="fa fa-arrow-right" aria-hidden="true"></i></button></li>
                    </ul>
                </div>
            </div>
